                        ...
                        <div class="row g-3">    
                            ...
                            <div class="tab-content" id="wizard-tabContent">
                                <div class="tab-pane fade show active" id="wizard-contact" role="tabpanel" aria-labelledby="wizard-contact-tab">
                                    <form class="row g-3 needs-validation custom-input" novalidate action="{{ route('community-press-releases.update', $details->id) }}" method="POST" enctype="multipart/form-data">
                                        @csrf
                                        @method('PUT')
                                        ...
                                        <div class="col-6">
                                            ...
                                            <img id="thumbnail-preview" src="{{ $details->thumbnail ? asset('uploads/community/' . $details->thumbnail) : '#' }}" alt="Image Preview" style="display: {{ $details->thumbnail ? 'block' : 'none' }}; margin-top: 10px; max-width: 100px; max-height: 100px;">
                                        </div>
                                        ...
                                        <div class="col-12">
                                            ...
                                            <input type="text" class="form-control" id="url" name="url" placeholder="Enter Detailed URL" value="{{ old('url', $details->url) }}" required>
