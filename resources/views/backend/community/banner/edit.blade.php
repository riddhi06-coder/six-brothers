                    ...
                    <div class="card-body">
                        ...
                        <div class="row g-3">    
                            ...
                            <div class="tab-content" id="wizard-tabContent">
                                ...
                                <form class="row g-3 needs-validation custom-input" novalidate action="{{ route('community-banner-details.update', $HomeBanner->id) }}" method="POST" enctype="multipart/form-data">
                                    @csrf
                                    @method('PUT')
                                     ...
                                     <div class="col-xxl-4 col-sm-6">
                                        ...
                                        <input class="form-control" id="banner_heading" type="text" name="banner_heading" placeholder="Enter Banner Heading" value="{{ old('banner_heading', $HomeBanner->banner_heading) }}" required>
                                    ...
                                    <div class="col-xxl-4 col-sm-6">
                                        ...
                                        @if($HomeBanner->banner_image)
                                            <div class="col-12">
                                                ...
                                                <div>
                                                    <img id="currentImage" src="{{ asset('uploads/community/' . $HomeBanner->banner_image) }}" alt="Banner Image" style="max-width: 100%;">
                                                </div>
                                            </div>
                                        @endif
