                ...
                <div class="card">
                  <div class="card-body">
                    ...
                    <div class="d-flex justify-content-between align-items-center mb-4">
                        ...
                        <a href="{{ route('cocktails.create') }}" class="btn btn-primary px-5 radius-30">+ Add Cocktails</a>
                    </div>
                        ...
                        <tbody>
                            @foreach($details as $key => $blog)
                                <tr>
                                    ...
                                    <td>
                                        @if($blog->thumbnail)
                                            <img src="{{ asset('uploads/cocktail/' . $blog->thumbnail) }}" alt="Banner Image" width="100">
                                        @else
