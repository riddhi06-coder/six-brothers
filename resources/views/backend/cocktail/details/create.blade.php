                        ...
                        <div class="row g-3">    
                            ...
                            <div class="tab-content" id="wizard-tabContent">
                                <div class="tab-pane fade show active" id="wizard-contact" role="tabpanel" aria-labelledby="wizard-contact-tab">
                                    <form class="row g-3 needs-validation custom-input" novalidate action="{{ route('cocktail-detail.store') }}" method="POST" enctype="multipart/form-data">
                                        @csrf
                                        ...
                                        <div class="col-6">
                                            ...
                                            <select class="form-control" id="cocktail_title" name="cocktail_title" required>
                                                <option value="" disabled selected>Select Cocktail Title</option>
                                        ...
                                        <div class="col-12">
                                            ...
                                            <textarea class="form-control" id="summernote" name="ingredients" placeholder="Enter INGREDIENTS" required>{{ old('ingredients') }}</textarea>
                                        ...
                                        <div class="col-12">
                                            ...
                                            <textarea class="form-control" id="summernote1" name="method" placeholder="Enter METHOD" required>{{ old('method') }}</textarea>
