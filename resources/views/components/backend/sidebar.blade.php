        ...
        <div class="sidebar-wrapper" data-layout="stroke-svg">
          <div class="logo-wrapper">
		  	<a href="{{ route('admin.dashboard') }}">
				<img class="img-fluid" src="{{ asset('admin/assets/images/logo/logo.png') }}" alt="" style="max-width: 65% !important;">
			</a>  
            ...
            <div id="sidebar-menu">
              <ul class="sidebar-links" id="simple-bar">
                ...
                <li class="sidebar-list"> <i class="fa fa-thumb-tack"> </i><a class="sidebar-link sidebar-title" href="#">
                    ...
                    <svg class="fill-icon">
                      <use href="{{ asset('admin/assets/svg/icon-sprite.svg#stroke-blog') }}"></use>
                    </svg><span>Our Community</span></a>
                  <ul class="sidebar-submenu">
                    <li><a href="{{ route('community-banner-details.index') }}">Banner Details</a></li>
                    <li><a href="{{ route('community-press-releases.index') }}">Press Releases</a></li>
                  </ul>
                </li>
